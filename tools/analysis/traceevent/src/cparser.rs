...
use crate::{
    cinterp::{
        Bitmap, CompileEnv, CompileError, EmptyEnv, EvalEnv, EvalError, EvalF, Evaluator,
        InterpError, Value,
    },
                ...
                map_res_cut(
                    ...
                    |(val, _, delim, flags)| {
                        ...
                        let compiler = Arc::new(move |cenv: &dyn CompileEnv<'_>, abi: &_| {
                            ...
                            let eval = EvalF::new_dyn(move |env: &_| {
            ...
            parser: Box::new(move |input| {
                map(many0(anychar), |_| ExtensionMacroCallCompiler {
                    ...
                    compiler: Arc::new(move |_, _| {
                        ...
                        let eval = EvalF::new_dyn(move |_| Ok(Value::I64Scalar(0)));
                        Ok(eval)
                    }),
                })
                .parse(input)
                ...
                map_res_cut(CGrammar::assignment_expr(), |expr| {
                    Ok(ExtensionMacroCallCompiler {
                        ...
                        compiler: Arc::new(move |cenv: &dyn CompileEnv, abi: &_| {
                            ...
                            let eval = EvalF::new_dyn(move |env: &_| match cexpr.eval(env)? {
